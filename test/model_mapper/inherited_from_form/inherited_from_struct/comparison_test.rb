...
class ModelMapperComparisonTest < Minitest::Test
  ...
  class SuspensionWithLessAttributes < FormObj::Form
    include FormObj::ModelMapper
  ...
  class ChassisWithLessAttributes < FormObj::Form
    include FormObj::ModelMapper
  ...
  class Team < FormObj::Form
    ...
    attribute :cars, array: true, primary_key: :code do
      ...
      attribute :chassis, class: 'ModelMapperComparisonTest::Chassis'
    end
    attribute :colours, class: Colour, array: true, primary_key: :name
  end
  class TeamWithLessAttributes < FormObj::Form
    include FormObj::ModelMapper
  ...
  class TeamWithDifferentAttributes < FormObj::Form
    include FormObj::ModelMapper
