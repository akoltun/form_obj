...
class ModelMapperSyncToModelsTest < Minitest::Test
  ...
  SuspensionModel = Struct.new(:front, :rear, :secret) { include ModelMarkableForDestruction }
  DriversChampionshipModel = Struct.new(:driver, :year, :secret) { include ModelMarkableForDestruction }
  ChassisModel = Struct.new(:chassis, :secret) { include ModelMarkableForDestruction }
  ...
  def test_that_all_attributes_value_are_correctly_synced_from_filled_form_into_empty_models
    ...
    assert_kind_of(::Array, @chassis_model.chassis)
    assert_equal([1, 5], @chassis_model.chassis.map { |chassis| chassis[:id] }.sort)
    ...
    chassis = @chassis_model.chassis.find { |chassis| chassis[:id] == 5 }
  ...
  def test_that_all_attributes_value_are_correctly_synced_from_filled_form_into_filled_models
    ...
    assert_kind_of(::Array, @chassis_model.chassis)
    assert_equal([1, 2, 5], @chassis_model.chassis.map { |chassis| chassis[:id] }.sort)
