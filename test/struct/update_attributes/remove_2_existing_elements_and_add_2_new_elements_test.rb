...
class StructUpdateAttributesAndRemoveTwoExistingElementsAndAddTwoNewElementsTest < Minitest::Test
  ...
  class Team < FormObj::Struct
    ...
    attribute :cars, array: true do
      ...
      attribute :chassis, class: 'StructUpdateAttributesAndRemoveTwoExistingElementsAndAddTwoNewElementsTest::Chassis'
    end
