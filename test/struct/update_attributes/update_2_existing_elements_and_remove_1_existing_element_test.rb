...
class StructUpdateAttributesOfTwoExistingElementsAndRemoveOneExistingElementTest < Minitest::Test
  ...
  class Team < FormObj::Struct
    ...
    attribute :cars, array: true do
      ...
      attribute :chassis, class: 'StructUpdateAttributesOfTwoExistingElementsAndRemoveOneExistingElementTest::Chassis'
    end
  ...
  def test_that_all_attributes_are_correctly_updated
    ...
    assert_equal(363,           team.cars[0].engine.power)              # <- this attribute keeps value because it was not updated and this is old element in the array
    ...
    assert_equal(5.7,         team.cars[1].engine.volume)               # <- this attribute keeps value because it was not updated and this is old element in the array
