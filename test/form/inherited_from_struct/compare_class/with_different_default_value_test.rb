...
class FormCompareClassWithDifferentDefaultValueTest < Minitest::Test
  ...
  class Team4 < FormObj::Form # Default primary key is id
    attribute :name, default: 'Ferrari'
    attribute :year
    attribute :top_cars, array: true, primary_key: :code, default: [{ code: '275 F1', driver: 'Ascari' }, { code: '340 F1', driver: 'Villoresi' }] do
      attribute :code
  ...
  class Team5 < FormObj::Form # Default primary key is id
    attribute :name, default: 'Ferrari'
    attribute :year
    attribute :top_cars, array: true, primary_key: :code, default: [{ code: '275 F1', driver: 'Ascari' }, { code: '340 F1', driver: 'Villoresi' }] do
      attribute :code
