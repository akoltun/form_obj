...
class FormUpdateAttributesOfOneExistingElementAndAddOneNewElementTest < Minitest::Test
  ...
  class Team < FormObj::Form
    ...
    attribute :cars, array: true do
      ...
      attribute :chassis, class: 'FormUpdateAttributesOfOneExistingElementAndAddOneNewElementTest::Chassis'
    end
