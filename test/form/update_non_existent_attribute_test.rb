...
class FormUpdateNonExistentAttributeTest < Minitest::Test
  ...
  class Team < FormObj::Form
    ...
    attribute :cars, array: true do
      ...
      attribute :driver
      attribute :chassis, class: 'FormUpdateNonExistentAttributeTest::Chassis'
    end
  end
  ...
  def test_that_non_existent_attribute_is_ignored_when_try_to_update_it
