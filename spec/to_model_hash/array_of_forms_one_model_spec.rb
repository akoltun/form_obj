RSpec.describe FormObj, concept: true do
  describe 'to_model_hash: array of forms - one model' do
    ...
    describe 'array of nested forms' do
      ...
      let(:form) { ToModelHash::ArrayOfForms::OneModel::Form.new }
    ...
    describe 'explicit declaration of nested forms in array' do
      ...
      let(:form) { ToModelHash::ArrayOfForms::OneModel::TeamForm.new }
