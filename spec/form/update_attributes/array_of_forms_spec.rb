RSpec.describe 'update_attributes: Array of Form Objects' do
  ...
  context 'Implicit declaration of form objects' do
    shared_examples 'implicitly declared form object' do
    ...
    context 'primary_key specified on attribute level' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyAttributeLevel::ArrayForm.new }

      it_behaves_like 'implicitly declared form object'
    end
    ...
    context 'primary_key specified on form level' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyFormLevel::ArrayForm.new }
  ...
  context 'Explicit declaration of form objects' do
    context 'primary_key specified on attribute level' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyAttributeLevel::ArrayForm::TeamForm.new }

      before do
        engine1 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayForm::EngineForm.new
        engine1.power = 335
        engine1.volume = 4.1
        ...
        engine2 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayForm::EngineForm.new
        engine2.power = 300
        engine2.volume = 3.3
      ...
      context 'initial form elements and updated elements are different' do
        ...
        context 'form initially has more elements than updated data' do
          before do
            ...
            engine3 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayForm::EngineForm.new
            engine3.power = 350
            engine3.volume = 4.5
    ...
    context 'primary_key specified on form level' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyFormLevel::ArrayForm::TeamForm.new }

      before do
        engine1 = UpdateAttributes::PrimaryKeyFormLevel::ArrayForm::EngineForm.new
        engine1.power = 335
        engine1.volume = 4.1
        ...
        engine2 = UpdateAttributes::PrimaryKeyFormLevel::ArrayForm::EngineForm.new
        engine2.power = 300
        engine2.volume = 3.3
      ...
      context 'initial form elements and updated elements are different' do
        ...
        context 'form initially has more elements than updated data' do
          before do
            ...
            engine3 = UpdateAttributes::PrimaryKeyFormLevel::ArrayForm::EngineForm.new
            engine3.power = 350
            engine3.volume = 4.5
