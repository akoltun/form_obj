RSpec.describe 'FormObj - update attributes', concept: true do
  ...
  context 'primary_key specified on attribute level' do
    describe 'array of nested forms' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::Form.new }
    ...
    describe 'explicit declaration of nested forms in array' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::TeamForm.new }
      before do
        engine1 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::EngineForm.new
        engine1.power = 335
        engine1.volume = 4.1

        car1 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::CarForm.new
        car1.model = '340 F1'
        car1.driver = 'Ascari'
        car1.engine = engine1

        engine2 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::EngineForm.new
        engine2.power = 300
        engine2.volume = 3.3

        car2 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::CarForm.new
        car2.model = '275 F1'
      ...
      context 'initial form elements and updated elements are different' do
        ...
        context 'form initially has more elements than updated data' do
          before do
            ...
            engine3 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::EngineForm.new
            engine3.power = 350
            engine3.volume = 4.5

            car3 = UpdateAttributes::PrimaryKeyAttributeLevel::ArrayOfForms::CarForm.new
            car3.model = '375 F1'
  ...
  context 'primary_key specified on form level' do
    describe 'array of nested forms' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyFormLevel::ArrayOfForms::Form.new }
    ...
    describe 'explicit declaration of nested forms in array' do
      ...
      let(:form) { UpdateAttributes::PrimaryKeyFormLevel::ArrayOfForms::TeamForm.new }
      before do
