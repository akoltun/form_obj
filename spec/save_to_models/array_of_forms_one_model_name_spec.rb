RSpec.describe FormObj, concept: true do
  describe 'SaveToModel: array of forms - one model - name' do
    module SaveToModel
      module ArrayOfForms
        module OneModelName
    ...
    let(:model) { SaveToModel::ArrayOfForms::OneModelName::Model.new }
    ...
    describe 'array of nested forms' do
        ...
        module ArrayOfForms
          module OneModelName
            class Form < FormObj
              ...
              attribute :year
              attribute :cars, array: true, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Car', primary_key: :model do
                attribute :model, model_attribute: :car_model
                attribute :driver
                attribute :engine, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Engine' do
                  attribute :power
                  attribute :volume
                end
              end
              attribute :sponsors, array: true, model_attribute: 'finance.:sponsors', model_class: ['Hash', 'SaveToModel::ArrayOfForms::OneModelName::Sponsor'], primary_key: :title do
                attribute :title
                attribute :money
              end
              attribute :chassis, array: true, hash: true do
                attribute :id
                attribute :suspension, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Suspension' do
                  attribute :front
                  attribute :rear
                end
                attribute :brakes
              end
              attribute :colours, array: true, model_attribute: false, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Colour', primary_key: :name do
                attribute :name
                attribute :rgb
              end
            end
      ...
      let(:form) { SaveToModel::ArrayOfForms::OneModelName::Form.new }
      ...
      context 'prefilled model' do
        before do
          ...
          model.cars = [
              SaveToModel::ArrayOfForms::OneModelName::Car.new('275 F1', 'Villo', SaveToModel::ArrayOfForms::OneModelName::Engine.new(200, 2.0, 101), 1),
              SaveToModel::ArrayOfForms::OneModelName::Car.new('M2B', 'Bruce McLaren', SaveToModel::ArrayOfForms::OneModelName::Engine.new(300, 3.0, 102), 2),
              SaveToModel::ArrayOfForms::OneModelName::Car.new('M7A', 'Denis Hulme', SaveToModel::ArrayOfForms::OneModelName::Engine.new(415, 4.3, 103), 3),
          ]

          model.finance = { sponsors: [
              SaveToModel::ArrayOfForms::OneModelName::Sponsor.new('Total', 250, 11),
              SaveToModel::ArrayOfForms::OneModelName::Sponsor.new('BP', 260, 12),
              SaveToModel::ArrayOfForms::OneModelName::Sponsor.new('Shell', 260, 13),
          ] }

          model.chassis = [
              { suspension: SaveToModel::ArrayOfForms::OneModelName::Suspension.new('independant', 'very old', 21), brakes: :disc, secret: 31, id: 1 },
              { suspension: SaveToModel::ArrayOfForms::OneModelName::Suspension.new('old', 'very old', 22), brakes: :drum, secret: 32, id: 3 },
          ]

          model[0] = SaveToModel::ArrayOfForms::OneModelName::Colour.new('red', 0xFF0000, 301)
          model[1] = SaveToModel::ArrayOfForms::OneModelName::Colour.new('green', 0x00FF00, 302)
          model[2] = SaveToModel::ArrayOfForms::OneModelName::Colour.new('blue', 0x0000FF, 303)
        end
    ...
    describe 'explicit declaration of nested forms in array' do
        ...
        module ArrayOfForms
          module OneModelName
            ...
            class CarForm < FormObj
              attribute :model, model_attribute: :car_model
              attribute :engine, class: EngineForm, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Engine'
              attribute :driver
            end
            ...
            class ChassisForm < FormObj
              attribute :id
              attribute :suspension, class: SuspensionForm, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Suspension'
              attribute :brakes
            end
            ...
            class TeamForm < FormObj
              attribute :name, model_attribute: :team_name
              attribute :year
              attribute :cars, array: true, class: CarForm, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Car', primary_key: :model
              attribute :sponsors, array: true, model_attribute: 'finance.:sponsors', class: SponsorForm, model_class: [Hash, 'SaveToModel::ArrayOfForms::OneModelName::Sponsor'], primary_key: :title
              attribute :chassis, array: true, hash: true, class: ChassisForm
              attribute :colours, array: true, model_attribute: false, class: ColourForm, model_class: 'SaveToModel::ArrayOfForms::OneModelName::Colour', primary_key: :name
            end
          end
        end
      end

      let(:form) { SaveToModel::ArrayOfForms::OneModelName::TeamForm.new }
      ...
      context 'prefilled model' do
        before do
          ...
          model.chassis = [
              { suspension: SaveToModel::ArrayOfForms::OneModelName::Suspension.new('independant', 'very old', 21), brakes: :disc, id: 1, secret: 31 },
              { suspension: SaveToModel::ArrayOfForms::OneModelName::Suspension.new('old', 'very old', 22), brakes: :drum, id: 3, secret: 32 },
          ]
