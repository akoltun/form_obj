RSpec.describe FormObj, concept: true do
  describe 'SaveToModel: nested form - one model' do
    ...
    let(:engine) { SaveToModel::NestedForm::OneModel::Engine.new }
    let(:suspension) { SaveToModel::NestedForm::OneModel::Suspension.new }
    ...
    context 'nested models are created when they do not exist yet' do
      ...
      describe 'nested form' do
        ...
        let(:form) { SaveToModel::NestedForm::OneModel::Form.new }
      ...
      describe 'explicit declaration of nested form classes' do
        ...
        let(:form) { SaveToModel::NestedForm::OneModel::TeamForm.new }
