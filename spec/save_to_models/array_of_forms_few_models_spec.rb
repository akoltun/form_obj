RSpec.describe FormObj, concept: true do
  describe 'SaveToModel: array of forms - few models' do
    module SaveToModel
      module ArrayOfForms
        module FewModels
    ...
    let(:model) { SaveToModel::ArrayOfForms::FewModels::Model.new }
    let(:chassis_model) { SaveToModel::ArrayOfForms::FewModels::Chassis.new }
    ...
    describe 'array of nested forms' do
      ...
      let(:form) { SaveToModel::ArrayOfForms::FewModels::Form.new }
      ...
      context 'prefilled model' do
        before do
          ...
          model.cars = [
              SaveToModel::ArrayOfForms::FewModels::Car.new('275 F1', 'Villo', SaveToModel::ArrayOfForms::FewModels::Engine.new(200, 2.0, 101), 1),
              SaveToModel::ArrayOfForms::FewModels::Car.new('M2B', 'Bruce McLaren', SaveToModel::ArrayOfForms::FewModels::Engine.new(300, 3.0, 102), 2),
              SaveToModel::ArrayOfForms::FewModels::Car.new('M7A', 'Denis Hulme', SaveToModel::ArrayOfForms::FewModels::Engine.new(415, 4.3, 103), 3),
          ]

          model.finance = { sponsors: [
              SaveToModel::ArrayOfForms::FewModels::Sponsor.new('Total', 250, 11),
              SaveToModel::ArrayOfForms::FewModels::Sponsor.new('BP', 260, 12),
              SaveToModel::ArrayOfForms::FewModels::Sponsor.new('Shell', 260, 13),
          ] }

          chassis_model.chassis = [
              { suspension: SaveToModel::ArrayOfForms::FewModels::Suspension.new('independant', 'very old', 21), brakes: :disc, secret: 31, id: 1 },
              { suspension: SaveToModel::ArrayOfForms::FewModels::Suspension.new('old', 'very old', 22), brakes: :drum, secret: 32, id: 3 },
          ]

          model[0] = SaveToModel::ArrayOfForms::FewModels::Colour.new('red', 0xFF0000, 301)
          model[1] = SaveToModel::ArrayOfForms::FewModels::Colour.new('green', 0x00FF00, 302)
          model[2] = SaveToModel::ArrayOfForms::FewModels::Colour.new('blue', 0x0000FF, 303)
        end
    ...
    describe 'explicit declaration of nested forms in array' do
      ...
      let(:form) { SaveToModel::ArrayOfForms::FewModels::TeamForm.new }
      ...
      context 'prefilled model' do
        before do
          ...
          chassis_model.chassis = [
              { suspension: SaveToModel::ArrayOfForms::FewModels::Suspension.new('independant', 'very old', 21), brakes: :disc, id: 1, secret: 31 },
              { suspension: SaveToModel::ArrayOfForms::FewModels::Suspension.new('old', 'very old', 22), brakes: :drum, id: 3, secret: 32 },
          ]
