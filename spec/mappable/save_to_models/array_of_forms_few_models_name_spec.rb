RSpec.describe 'save_to_models: Array of Form Objects - Few Models - Name' do
  ...
  let(:model) { SaveToModels::ArrayFormName::Model.new }
  let(:chassis_model) { SaveToModels::ArrayFormName::Chassis.new }
  ...
  context 'Implicit declaration of form object classes' do
    module SaveToModels
      class ArrayFormName < FormObj::Form
        ...
        attribute :cars, array: true, model_class: 'SaveToModels::ArrayFormName::Car', primary_key: :model do
          ...
          attribute :driver
          attribute :engine, model_class: 'SaveToModels::ArrayFormName::Engine' do
            attribute :power
            attribute :volume
          end
        end
        attribute :sponsors, array: true, model_attribute: 'finance.:sponsors', model_class: ['Hash', 'SaveToModels::ArrayFormName::Sponsor'], primary_key: :title do
          attribute :title
          attribute :money
        end
    ...
    context 'prefilled model' do
      before do
        ...
        model.cars = [
            SaveToModels::ArrayFormName::Car.new('275 F1', 'Villo', SaveToModels::ArrayFormName::Engine.new(200, 2.0, 101), 1),
            SaveToModels::ArrayFormName::Car.new('M2B', 'Bruce McLaren', SaveToModels::ArrayFormName::Engine.new(300, 3.0, 102), 2),
            SaveToModels::ArrayFormName::Car.new('M7A', 'Denis Hulme', SaveToModels::ArrayFormName::Engine.new(415, 4.3, 103), 3),
        ]

        model.finance = { sponsors: [
            SaveToModels::ArrayFormName::Sponsor.new('Total', 250, 11),
            SaveToModels::ArrayFormName::Sponsor.new('BP', 260, 12),
            SaveToModels::ArrayFormName::Sponsor.new('Shell', 260, 13),
        ] }

        chassis_model.chassis = [
            { suspension: SaveToModels::ArrayFormName::Suspension.new('independant', 'very old', 21), brakes: :disc, secret: 31, id: 1 },
            { suspension: SaveToModels::ArrayFormName::Suspension.new('old', 'very old', 22), brakes: :drum, secret: 32, id: 3 },
        ]

        model[0] = SaveToModels::ArrayFormName::Colour.new('red', 0xFF0000, 301)
        model[1] = SaveToModels::ArrayFormName::Colour.new('green', 0x00FF00, 302)
        model[2] = SaveToModels::ArrayFormName::Colour.new('blue', 0x0000FF, 303)
      end
  ...
  context 'Explicit declaration of form object classes' do
    module SaveToModels
      class ArrayFormName < FormObj::Form
        ...
        class TeamForm < FormObj::Form
          ...
          attribute :name, model_attribute: :team_name
          attribute :year
          attribute :cars, array: true, class: CarForm, model_class: 'SaveToModels::ArrayFormName::Car', primary_key: :model
    ...
    context 'prefilled model' do
      before do
        ...
        chassis_model.chassis = [
            { suspension: SaveToModels::ArrayFormName::Suspension.new('independant', 'very old', 21), brakes: :disc, id: 1, secret: 31 },
            { suspension: SaveToModels::ArrayFormName::Suspension.new('old', 'very old', 22), brakes: :drum, id: 3, secret: 32 },
        ]
